...
function CartItems() {
  const {  getTotalCartAmount, all_products, cartItems, addToCart, removeToCart } =
    useContext(ShopContext);
  return (
    <section className="flex flex-col flexCenter max_padd_container pt-28 "> 
                ...
                >
                  ...
                  <td>
                    <div className="bold-22 pl-14">
                      <TbTrash c onClick={() => removeToCart(e.id)} />
                    </div>
                  </td>
                </tr>
              );
      ...
      <div className="flex flex-col gap-20 my-16 p-8 md:flex-row rounded-md bg-white w-full max-w-[666px]">
        <div className="flex flex-col gap-10 w-full">
          ...
          <div>
            ...
            <hr />
            <div className="flexBetween py-4">
              <h2 className="bold-18">Total : </h2>
              <h2 className="bold-18">${getTotalCartAmount()}</h2>
            </div>
